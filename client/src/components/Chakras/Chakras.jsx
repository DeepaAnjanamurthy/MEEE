        ...
        <div className="">
            ...
            <div className="chakraspage">
                ...
                <div className="chakrasnames">
                    ...
                    <Link className="chakralink" to={"/chakra/7"}>
                    ...
                    <Link className="chakralink" to={"/chakra/6"}>
                        <div className="imglabeldiv">
                    ...
                    <Link className="chakralink" to={"/chakra/5"}>
                        <div className="imglabeldiv">
                    ...
                    <Link className="chakralink" to={"/chakra/4"}>
                        <div className="imglabeldiv">
                    ...
                    <Link className="chakralink" to={"/chakra/3"}>
                        <div className="imglabeldiv">
